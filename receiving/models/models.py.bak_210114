...
class ReceivingAsn(models.Model):
     ...
     name = fields.Char(readonly=True, string = 'ASN Number')
     description = fields.Char(readonly=True)
     serialnumber = fields.Char(readonly=True, string = 'Serial Number')
     manufacturer = fields.Char(readonly=True)
     model = fields.Char(readonly=True)
     modelnumber = fields.Char(readonly=True)
     storage = fields.Char(readonly=True)
     color = fields.Char(readonly=True)
     carrier = fields.Char(readonly=True)
     imei = fields.Char(required=True)
     imei2 = fields.Char(readonly=True)
     userid = fields.Char()
